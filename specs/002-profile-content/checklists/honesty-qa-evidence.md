...
- [x] CHK001 - ¿Está acotado con un mínimo/máximo el volumen de casos de prueba "representativos" exigido en FR-011, o queda sin cuantificar? [Completeness, Spec §FR-011] — **Resuelto 2026-07-14, superado 2026-07-16**: los mínimos existen, pero desde la enmienda a la constitución v2.0.0 aplican a la sección "Evidencia de QA" del sitio del proyecto (FR-012 actual), no al portfolio — FR-011 ahora es el enlace prominente al proyecto.
- [x] CHK002 - ¿Se especifica qué cantidad o tipo de evidencia hace que la automatización sea "concreta" en FR-012, o cualquier evidencia mínima lo satisface? [Completeness, Spec §FR-012] — **Resuelto 2026-07-14, superado 2026-07-16**: mismo caso que CHK001 — el criterio de "evidencia tangible" sigue vigente pero ahora describe qué debe tener la sección de evidencia del sitio del proyecto, no del portfolio.
